...
import { Pizza, Mail, Lock, TrendingUp, Users, ShoppingBag } from "lucide-react";
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="space-y-8">
            <motion.div
              ...
              className="overflow-hidden rounded-3xl border-4 border-white/20 shadow-2xl backdrop-blur-sm"
            >
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1597958792579-bd3517df6399?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb3VybWV0JTIwZm9vZCUyMGJvd2wlMjBkZWxpdmVyeXxlbnwxfHx8fDE3ODIyNTQ4ODh8MA&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            >
              <h2 className="text-3xl font-bold text-white">
                Transforme seu delivery em um negócio de sucesso
              </h2>
              <p className="mt-3 text-lg text-white/80">
                Gerencie pedidos, cardápio, cozinha e relatórios em uma única plataforma profissional.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <p className="text-sm text-white/70">Aumento nas vendas</p>
            </div>
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              <Users className="h-8 w-8 text-white/90" />
              <p className="mt-2 text-2xl font-bold text-white">2.5K+</p>
              <p className="text-sm text-white/70">Restaurantes ativos</p>
            </div>
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              <ShoppingBag className="h-8 w-8 text-white/90" />
              <p className="mt-2 text-2xl font-bold text-white">50K+</p>
              <p className="text-sm text-white/70">Pedidos por dia</p>
            </div>
          </motion.div>
        </div>
      </div>
          ...
          <div className="grid gap-3">
            ...
            <Button variant="outline" className="h-12 rounded-xl">
              <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M11.4 24H0V8h11.4v16zM24 8v16h-11.4V8H24zm-4.9 2.2c-.2-.3-.6-.4-.9-.4h-3.5v1.8h3.5c.3 0 .7-.1.9-.4.2-.3.3-.6.3-.9 0-.4-.1-.8-.3-1.1z" />
              </svg>
